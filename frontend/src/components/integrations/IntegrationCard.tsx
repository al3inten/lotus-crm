...
const INTEGRATION_UI: Record<IntegrationKey, { title: string; desc: string; icon: ReactNode }> = {
  ...
  INSTAGRAM: {
    ...
    icon: (
      <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#DD2A7B]">
  ...
  TELECMI: {
    ...
    icon: <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-500"><PhoneCall className="h-6 w-6 text-white" /></div>,
  },
  GEMINI: {
    title: "Gemini (AI)",

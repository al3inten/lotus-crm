 ...
 * ::before can track the cursor with a translucent spotlight highlight. */
...
export function Metric({ value, suffix, label }: { value: number; suffix?: string; label: string }) {
  ...
  return (
    <div ref={ref} className="text-center">
      <div className="text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl dark:text-white">

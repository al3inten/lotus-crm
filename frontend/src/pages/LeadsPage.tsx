...
import { Car, ChevronLeft, ChevronRight, FileSpreadsheet, Users, Loader2, Table2, Plus, Upload, UserSearch } from "lucide-react";
...
// Card and Kanban views are temporarily disabled — commented out for now.
    ...
    <div className="flex items-center rounded-xl bg-white/5 p-1 ring-1 ring-white/10 backdrop-blur-md">
      {VIEW_OPTIONS.map(({ mode, label, icon: Icon }) => (
        <button
          ...
          className={clsx(
            "flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500/50",
      ...
      <div className="relative overflow-hidden rounded-3xl bg-[#0B0F19] px-6 py-8 shadow-2xl shadow-primary-900/10 ring-1 ring-slate-900/5 dark:bg-slate-950 dark:ring-white/10 sm:px-9 sm:py-9">
        ...
        <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-4">
            <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-slate-800 text-white shadow-inner ring-1 ring-white/20">

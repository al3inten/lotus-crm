        ...
        <div className="relative overflow-hidden rounded-3xl bg-slate-900 px-8 py-10 shadow-2xl dark:bg-slate-950 sm:px-12 sm:py-14">
          ...
          <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl">
              <span className="inline-flex items-center rounded-full bg-pink-500/10 px-3 py-1 text-sm font-medium text-pink-300 ring-1 ring-inset ring-pink-500/20 backdrop-blur-md">
                Engagement Center
              </span>

    ...
    <div className="mx-auto w-full max-w-7xl flex flex-col gap-6">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-slate-900 px-6 py-8 shadow-xl dark:bg-slate-950 sm:px-8 sm:py-10">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute -left-[10%] -top-[50%] h-[200%] w-[50%] rounded-full bg-pink-600/30 blur-[100px] dark:bg-pink-600/20" />
          <div className="absolute -right-[20%] top-[-20%] h-[150%] w-[60%] rounded-full bg-orange-500/20 blur-[120px] dark:bg-orange-500/10" />
        </div>

        <div className="relative z-10 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            <span className="inline-flex items-center rounded-full bg-pink-500/10 px-2.5 py-0.5 text-xs sm:text-sm font-medium text-pink-300 ring-1 ring-inset ring-pink-500/20 backdrop-blur-md">
              Engagement Center
            </span>
